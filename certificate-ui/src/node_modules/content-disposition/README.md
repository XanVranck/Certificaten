...
```js
res.setHeader('Content-Disposition', contentDisposition('∫ maths.be.jasper.pdf'))
```
...
var filePath = '/path/to/public/plans.be.jasper.pdf'

http.createServer(function onRequest(req, res) {
  // set headers
  res.setHeader('Content-Type', 'application/be.jasper.pdf')
